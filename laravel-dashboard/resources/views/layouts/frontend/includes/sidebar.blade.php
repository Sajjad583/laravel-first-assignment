    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a href="{{ url('html/index.html') }}" class="logo-link nk-sidebar-logo">
                <img class="logo-light logo-img" src="{{ asset('assets/images/images/jsTree/logo.png') }}" srcset="{{ asset('assets/images/jsTree/logo2x.png') }} 2x" alt="logo">
                <img class="logo-dark logo-img" src="{{ asset('assets/images/jsTree/logo-dark.png') }}" srcset="{{ asset('assets/images/jsTree/logo-dark2x.png') }} 2x" alt="logo-dark">
                <img class="logo-small logo-img logo-img-small" src="{{ asset('assets/images/jsTree/logo-small.png') }}" srcset="{{ asset('assets/images/jsTree/logo-small2x.png') }} 2x" alt="logo-small">
            </a>
